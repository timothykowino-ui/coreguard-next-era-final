      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className={`max-w-6xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-primary font-light tracking-wide italic">
              Every angle engineered for protection and poise
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-block relative">
              ...
              />
              <p className="relative text-lg text-muted-foreground italic">
